...
int CPU::Opcode03() { return OpcodeINCWord(m_bc); }
...
int CPU::Opcode0B() { return OpcodeDECWord(m_bc); }
int CPU::Opcode0C() { return OpcodeINC(m_c); }
int CPU::Opcode0D() { return OpcodeDEC(m_c); }
int CPU::Opcode0E() { return OpcodeLD(m_c); }
int CPU::Opcode0F() { return 0; }

int CPU::Opcode10() { return 0; }
int CPU::Opcode11() { return 0; }
int CPU::Opcode12() { return 0; }
int CPU::Opcode13() { return OpcodeINCWord(m_de); }
int CPU::Opcode14() { return OpcodeINC(m_d); }
int CPU::Opcode15() { return OpcodeDEC(m_d); }
int CPU::Opcode16() { return OpcodeLD(m_d); }
int CPU::Opcode17() { return 0; }
int CPU::Opcode18() { return OpcodeJR(); }
int CPU::Opcode19() { return 0; }
int CPU::Opcode1A() { return 0; }
int CPU::Opcode1B() { return OpcodeDECWord(m_de); }
int CPU::Opcode1C() { return OpcodeINC(m_e); }
int CPU::Opcode1D() { return OpcodeDEC(m_e); }
int CPU::Opcode1E() { return OpcodeLD(m_e); }
int CPU::Opcode1F() { return 0; }

int CPU::Opcode20() { return OpcodeJR(!m_f.Zero()); }
int CPU::Opcode21() { return 0; }
int CPU::Opcode22() { return 0; }
int CPU::Opcode23() { return OpcodeINCWord(m_hl); }
int CPU::Opcode24() { return OpcodeINC(m_h); }
int CPU::Opcode25() { return OpcodeDEC(m_h); }
int CPU::Opcode26() { return OpcodeLD(m_h); }
int CPU::Opcode27() { return 0; }
int CPU::Opcode28() { return OpcodeJR(m_f.Zero()); }
int CPU::Opcode29() { return 0; }
int CPU::Opcode2A() { return 0; }
int CPU::Opcode2B() { return OpcodeDECWord(m_hl); }
int CPU::Opcode2C() { return OpcodeINC(m_l); }
int CPU::Opcode2D() { return OpcodeDEC(m_l); }
int CPU::Opcode2E() { return OpcodeLD(m_l); }
int CPU::Opcode2F() { return 0; }

int CPU::Opcode30() { return OpcodeJR(!m_f.Carry()); }
int CPU::Opcode31() { return 0; }
int CPU::Opcode32() { return 0; }
int CPU::Opcode33() { return OpcodeINCWord(m_sp); }
int CPU::Opcode34() { return OpcodeINC(m_hl); }
int CPU::Opcode35() { return OpcodeDEC(m_hl); }
int CPU::Opcode36() { return OpcodeLD(m_hl); }
int CPU::Opcode37() { return 0; }
int CPU::Opcode38() { return OpcodeJR(m_f.Carry()); }
int CPU::Opcode39() { return 0; }
int CPU::Opcode3A() { return 0; }
int CPU::Opcode3B() { return OpcodeDECWord(m_sp); }
int CPU::Opcode3C() { return OpcodeINC(m_a); }
int CPU::Opcode3D() { return OpcodeDEC(m_a); }
int CPU::Opcode3E() { return OpcodeLD(m_a); }
